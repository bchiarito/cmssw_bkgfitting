...
python run_fitter.py $1 --testBin "noniso_sym barrel 100" --useScaledTight
python run_fitter.py $1 --testBin "noniso_sym barrel 100"
python run_plotter.py $1 --testBin "noniso_sym barrel 100" --useScaledTight --show
rm $1/plots.pdf
#xdg-open $1/test.pdf
